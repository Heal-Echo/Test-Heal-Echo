...
// lambda/admin-balance-multipart-part.ts
var admin_balance_multipart_part_exports = {};
__export(admin_balance_multipart_part_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(admin_balance_multipart_part_exports);
