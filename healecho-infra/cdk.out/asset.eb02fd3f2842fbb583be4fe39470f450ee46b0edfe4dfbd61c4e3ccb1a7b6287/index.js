...
// lambda/public-get-videos.ts
var public_get_videos_exports = {};
__export(public_get_videos_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(public_get_videos_exports);
var import_aws_sdk = __toESM(require("aws-sdk"));
var dynamo = new import_aws_sdk.default.DynamoDB();
var TABLE = process.env.VIDEO_TABLE_NAME;
var handler = async () => {
  try {
    const getRes = await dynamo.getItem({
      TableName: TABLE,
      Key: {
        id: { S: "featured" }
      }
