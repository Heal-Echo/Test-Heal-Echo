// src/app/api/user/practice-record/route.ts
// ==========================================
// POST /api/user/practice-record — 실천 기록 저장
// GET  /api/user/practice-record — 실천 기록 조회
// ==========================================
...
export async function POST(req: Request) {
  try {
    ...
    const url = `${base}/user/practice-record`;
    ...
    console.error("[User Practice Record POST] error:", err);
...
export async function GET(req: Request) {
  try {
    ...
    const url = `${base}/user/practice-record${qs}`;
    ...
    console.error("[User Practice Record GET] error:", err);
    return NextResponse.json({ error: "Failed to load practice records" }, { status: 500 });
  }
}
