// src/app/api/admin/users/[userId]/watch-records/route.ts
// GET /api/admin/users/{userId}/watch-records — 시청 기록 조회
...
export async function GET(req: Request, { params }: { params: { userId: string } }) {
  try {
    ...
    const url = `${base}/admin/users/${encodeURIComponent(params.userId)}/watch-records${qs ? `?${qs}` : ""}`;
