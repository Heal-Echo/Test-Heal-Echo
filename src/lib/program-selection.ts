 ...
 */
export function syncProgramSelection(programId: string, options?: { isChange?: boolean }): void {
...
async function savePreferencesToAWS(prefs: Record<string, string | boolean>): Promise<void> {
  try {
