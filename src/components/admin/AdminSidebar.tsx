    ...
    >
      ...
      >
        ...
        <Link
          ...
          style={linkStyle(pathname === "/admin/dashboard")}
        >
          대시보드
        </Link>
        ...
        <Link
          ...
          style={linkStyle(pathname === "/admin/monitoring")}
        >
          실시간 모니터링
        </Link>
        ...
        <Link href="/admin/studio/introduction">
          <div
            style={subText(pathname.startsWith("/admin/studio/introduction"))}
          >
            · Introduction
          </div>
        </Link>
        ...
        {/* Weekly Solution */}
        <div style={{ ...menuTitle, marginTop: 24, fontSize: "13px" }}>
          위클리 솔루션
        </div>
        ...
        <Link href="/admin/studio/weekly-solution/autobalance">
          <div
            style={subText(
              pathname.startsWith(
                "/admin/studio/weekly-solution/autobalance"
              )
            )}
          >
        ...
        <Link href="/admin/studio/weekly-solution/womans-whisper">
          <div
            style={subText(
              pathname.startsWith(
                "/admin/studio/weekly-solution/womans-whisper"
              )
            )}
          >
        ...
        <Link href="/admin/studio/weekly-solution/healing-mind">
          <div
            style={subText(
              pathname.startsWith(
                "/admin/studio/weekly-solution/healing-mind"
              )
            )}
          >
            · 힐링 마인드
        ...
        <Link href="/admin/studio/weekly-habit/autobalance">
          <div
            style={subText(
              pathname === "/admin/studio/weekly-habit/autobalance"
            )}
          >
            · {getProgramName("autobalance")}
          </div>
        ...
        <Link href="/admin/studio/weekly-habit/autobalance/sleep-habit">
          <div
            style={{
              ...subText(
                pathname.startsWith("/admin/studio/weekly-habit/autobalance/sleep-habit")
              ),
              paddingLeft: 28,
              fontSize: "12px",
            }}
        ...
        <Link href="/admin/studio/weekly-habit/womans-whisper">
          <div
            style={subText(
              pathname.startsWith(
                "/admin/studio/weekly-habit/womans-whisper"
              )
            )}
          >
            · {getProgramName("womans-whisper")}
        ...
        <Link href="/admin/studio/weekly-habit/healing-mind">
          <div
            style={subText(
              pathname.startsWith("/admin/studio/weekly-habit/healing-mind")
            )}
          >
            · 힐링 마인드
          </div>
        ...
        <Link href="/admin/studio/sea-of-understanding">
          <div
            style={subText(
              pathname.startsWith("/admin/studio/sea-of-understanding")
            )}
          >
            · Understanding Video
          </div>
        ...
        <Link href="/admin/members">
          <div
            style={subText(pathname.startsWith("/admin/members"))}
          >
            · 회원 목록
          </div>
        </Link>
        <div style={{ ...subText(false), color: "#bbb", cursor: "default" }}>· 유료 결제 정보 (준비 중)</div>
        <div style={{ ...subText(false), color: "#bbb", cursor: "default" }}>· 결제 수단 / 프로모션 (준비 중)</div>
        <div style={{ ...subText(false), color: "#bbb", cursor: "default" }}>· 환불 및 취소 이력 (준비 중)</div>
