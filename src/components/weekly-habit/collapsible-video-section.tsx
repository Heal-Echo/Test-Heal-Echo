...
export default function CollapsibleVideoSection({
  ...
  return (
    <>
      ...
      <div className={`${styles.sheet} ${expanded ? styles.sheetExpanded : styles.sheetCollapsed}`}>
        {/* ── 핸들 바 (항상 보임) ── */}
        <button className={styles.handle} onClick={handleToggle} type="button">
          ...
          <div className={styles.handleContent}>
            ...
            <span className={`${styles.handleArrow} ${expanded ? styles.handleArrowOpen : ""}`}>
      ...
      {toastMsg && (
        <div
          className={`${styles.toast} ${toastVisible ? styles.toastVisible : styles.toastHidden}`}
        >
